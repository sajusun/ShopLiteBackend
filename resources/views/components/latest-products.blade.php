<div id="products" class="container mx-auto px-6 py-1">
    <h3 class="text-2xl font-bold text-gray-800 mb-8">Latest Featured Products</h3>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow hover:shadow-xl transition">
                ...
                <div class="p-4">
                    ...
                    <div class="mt-3 flex items-center justify-between">
                        ...
                        <button class="bg-indigo-600 text-white text-sm px-3 py-1.5 rounded hover:bg-indigo-700">Add
                            to Cart
                        </button>
                    </div>
                </div>
