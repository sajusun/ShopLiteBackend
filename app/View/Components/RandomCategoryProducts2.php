...
class RandomCategoryProducts2 extends Component
{
    ...
    public function __construct()
    {
        ...
        $data = Cache::remember('random_category_products2', 300, function () {
    ...
    {
        return view('components.random-category-products2');
    }
}
